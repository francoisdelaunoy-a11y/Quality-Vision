...
const PRODUCTS = {
  ...
  helmet: {
    name: "Van Rysel RoadR 500 road bike helmet",
    short: "RoadR 500 helmet",
    family: "molding",
    familyLabel: "Bike helmets",
    context: "In-mold EPS foam with polycarbonate micro-shell, retention system assembly",
    defaults: { country: "China", nq: "spike", iso: "certified", extras: [], qa: "strong", dpr: "compliant" },
    techPack: [
      { id: "mat", kind: "Material", text: "In-mold EPS liner, polycarbonate micro-shell, nylon straps, PA retention dial", conf: 0.95 },
      { id: "proc", kind: "Process", text: "In-mold co-molding of shell and EPS, strap anchor insertion, retention system assembly", conf: 0.91 },
      { id: "impact", kind: "Critical characteristic", text: "Impact attenuation, below 250 g on flat and kerbstone anvils", conf: 0.94 },
      { id: "strap", kind: "Critical characteristic", text: "Retention system strength, elongation below 35 mm under dynamic load", conf: 0.89 },
      { id: "roll", kind: "Critical characteristic", text: "Roll-off stability, stays on head form under forward and rearward pull", conf: 0.88 },
      { id: "dens", kind: "Critical characteristic", text: "EPS liner density, 60 to 70 g/L uniform across the liner", conf: 0.9 },
      { id: "reg", kind: "Regulatory", text: "EN 1078 bike helmets, CE marking, CPSC 1203 for the US range", conf: 0.97 },
    ],
    reviews: [
      { id: "peel", text: "Shell peels away from the foam", freq: "medium", sev: "severe", maps: ["proc", "mat"], quote: "The outer shell started lifting off the foam at the edge after one summer." },
      { id: "dial", text: "Retention dial slips or breaks", freq: "frequent", sev: "minor", maps: ["strap", "proc"], quote: "The rear dial will not hold; it loosens on every bump." },
      { id: "wobble", text: "Sits too high and rocks on the head", freq: "medium", sev: "minor", maps: ["roll"], quote: "Comfortable, but it tips forward every time I look down." },
      { id: "pad", text: "Comfort pads come unglued", freq: "rare", sev: "minor", maps: ["mat"], quote: "Front pad fell out after three rides." },
    ],
    pool: [
      { id: "h1", label: "Impact attenuation on flat and kerbstone anvils, conditioned samples per lot", method: "lab", base: 5, tech: ["impact"], review: [], tags: ["lab", "final"] },
      { id: "h2", label: "In-mold cycle: steam pressure, temperature and dwell logged per shot", method: "inline", base: 5, tech: ["proc", "dens"], review: ["peel"], tags: ["process", "inline"] },
      { id: "h3", label: "Retention system dynamic test, elongation below 35 mm", method: "lab", base: 5, tech: ["strap"], review: ["dial"], tags: ["lab", "final"] },
      { id: "h4", label: "EPS bead density and fusion check on liner samples per lot", method: "inline", base: 4, tech: ["dens", "mat"], review: ["peel"], tags: ["process", "inline"] },
      { id: "h5", label: "Shell-to-foam adhesion peel test after heat aging", method: "lab", base: 4, tech: ["proc", "mat"], review: ["peel"], tags: ["lab"] },
      { id: "h6", label: "Roll-off test on head forms, forward and rearward", method: "lab", base: 4, tech: ["roll"], review: ["wobble"], tags: ["lab", "final"] },
      { id: "h7", label: "EN 1078 type-test report valid for shell and liner revision", method: "doc", base: 4, tech: ["reg"], review: [], tags: ["doc"] },
      { id: "h8", label: "Retention dial and strap sub-assembly source and change control", method: "doc", base: 4, tech: ["strap"], review: ["dial"], tags: ["doc", "subcontract"] },
      { id: "h9", label: "Strap anchors seated before molding, 100% visual at press", method: "visit", base: 4, tech: ["proc", "strap"], review: [], tags: ["final", "visit"] },
      { id: "h10", label: "Dial mechanism cycling, 5,000 adjustments", method: "lab", base: 3, tech: ["strap"], review: ["dial"], tags: ["lab"] },
      { id: "h11", label: "EPS raw bead lot traceability to helmet lot", method: "doc", base: 3, tech: ["mat"], review: ["peel"], tags: ["doc", "subcontract"] },
      { id: "h12", label: "Corrective actions from last recall closed and verified", method: "doc", base: 3, tech: [], review: [], tags: ["doc", "process", "final"] },
      { id: "h13", label: "Final inspection sampling plan applied (AQL 1.0)", method: "doc", base: 3, tech: [], review: [], tags: ["final", "doc"] },
      { id: "h14", label: "Impact rig, head forms and drop mass calibrated", method: "doc", base: 2, tech: ["impact"], review: [], tags: ["doc", "lab"] },
      { id: "h15", label: "Night shift in-mold press matches day shift settings", method: "visit", base: 2, tech: ["proc"], review: [], tags: ["visit", "process"] },
      { id: "h16", label: "Comfort pad adhesive application and cure log", method: "inline", base: 2, tech: ["mat"], review: ["pad"], tags: ["process"] },
      { id: "h17", label: "Operator training records for in-mold press stations", method: "doc", base: 2, tech: ["proc"], review: [], tags: ["doc", "process"] },
      { id: "h18", label: "Shell print and logo adhesion", method: "lab", base: 1, tech: [], review: [], tags: ["lab"] },
      { id: "h19", label: "Vent mesh and visor fit", method: "lab", base: 1, tech: [], review: [], tags: ["lab"] },
      { id: "h20", label: "Box and hangtag specification", method: "doc", base: 1, tech: [], review: [], tags: ["doc"] },
    ],
  },
};
